...
<div class="container">
		<form:form method="POST" action="saveItemForm" modelAttribute="product">
			<table class="table table-striped">
				<tr>
					<td>ID:</td>
	...
	<div class="container">
		<form:form action="displayItem" method="GET" modelAttribute="product">
			<table class="table table-striped">
			<tr>
				...
				<tr>
				   ...
				   <td><a class="add_to_cart_button" data-quantity="1"
									data-productId="" data-productId="70" rel="nofollow"
									href="#"
									onclick="'javascript:addItemToCart(\'' + ${product.productId} + '\');'">Add to cart</a> </td>
			</tr>
		</table>
		</form:form>
</div>
